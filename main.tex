...
\usepackage[backend=bibtex,style=authortitle,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\author{Federico \textsc{D'Ambrosio}, Edoardo Ferrante} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
