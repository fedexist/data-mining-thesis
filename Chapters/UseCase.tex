...
\input{HadoopClusterDeploymentUseCase}

\subsection{Flink \& Cassandra Deployment}

\input{FlinkCassandraDeploymentUseCase}

\subsection{Deployed Software \& Versions}

\input{DeployedSoftwareUseCase}

\section{Development}

\subsection{Ingestion}

\input{IngestionUseCase}

\subsection{Processing}

\input{ProcessingUseCase}

\subsection{Serving \& Security}

\input{ServingSecurityUseCase}

\subsection{Accessory Services}

\input{AccessoryServicesUseCase}

\subsection{Visualisation}

\input{VisualisationUseCase}