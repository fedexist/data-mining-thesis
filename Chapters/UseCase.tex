...
Note: additional 10 VMs have been provisioned in the same environment for a \textbf{MongoDB} cluster, used as an additional data sink after Flink processing.
